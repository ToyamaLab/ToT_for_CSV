...
def handle_args():
    ...
    parser.add_argument('-c', '--country', choices=['us', 'uk', 'fk', 'jp', 'us2'], \
                        default='us', help='Target country', type=str)
...
def get_single_result(country, start, rows):
    ...
    r = requests.get(get_url(country), params=params_str)
...
if __name__ == '__main__':
    ...
    while offset < args.total:
        res = get_single_result(args.country, offset, args.rows)
