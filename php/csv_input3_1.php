...
<div class="container">
  <div class="row">
    <div class="col-lg-6 col-lg-offset-3">
      ...
      <form action="./csv_input3_2.php" method="post" enctype="multipart/form-data">
       <!-- <div class="form-group">
        ...
        <div class="form-group">
          ...
          <br>
        Every<input type="number" name="number">days
        </div>
        <div class="form-group">
          <label>Switching Crawler</label><br>
        <input type="radio" name="switch" value="t"/>ON<br/>
        <input type="radio" name="switch" value="f"/>OFF<br/>
        </div>
