...
//行指定csvの変換/header無しclass・eclipse・php・パラメータあり
	public static void main(String[] args) throws ClassNotFoundException 
	{
		...
		try{
			...
			csv2db(table, br, url, user, password,start,last); //CSVでDBの内容を追加(上書き)する
	...
	**/
	private static void csv2db(String table, BufferedReader br, String url, String user, String password, Integer start, Integer last) 
	{
			...
			while((line = br.readLine()) != null)
			{
				...
				**/
				while(token.hasMoreTokens())
				{
					...
					//2と3列目だけ
					if(column_queue >= start && column_queue <= last) insert += "\'" + tmpString + "\', ";
				}
