...
//クロス表をリスト化するclass・eclipse・php
	public static void main(String[] args) throws ClassNotFoundException 
	{
		...
		String inputCsv = args.length>0 ? args[0] : basedir + "/csv/cross_sample1.csv";
		String outputCsv = args.length>0 ? args[0] : basedir + "/csv/cross_sample1_tmp.csv";
